...
Shader "HoloToolkit/Fast Configurable"
{
    Properties
    {
		...
		[Indent]
			...
			/*_PlaneD("_PlaneD",Float) = 0
			_PlaneN("_PlaneN", Vector) = (0,0,0,0)*/
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma shader_feature _MRICLIPPING_ON
			...
			uniform float3 _PlaneD;
			uniform float3 _PlaneN;
			...
			v2f vert(a2v v)
			{
				...
				float3 distFromPlane = mul(unity_ObjectToWorld, v.vertex).xyz - _PlaneD;
				o.PlaneDistance = dot(distFromPlane, _PlaneN);
