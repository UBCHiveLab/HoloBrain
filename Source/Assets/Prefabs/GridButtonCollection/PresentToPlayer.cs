...
namespace HoloBrain.IsolateMode
{
    public class PresentToPlayer : MonoBehaviour
    {
        ...
        Vector3 initialStructurePosition;
        Quaternion initialStructureRotation;
        ...
        IEnumerator PresentOverTime()
        {
            ...
            Brain = TargetTranfsorm.transform.Find("Element/BrainContainer/BrainStructures");
            initialPosition = transform.position;
            initialRotation = transform.rotation;
            initialStructurePosition = Brain.transform.localPosition;
            initialStructureRotation = Brain.transform.rotation;
            ...
            Brain.transform.localPosition = initialStructurePosition;
            Brain.transform.rotation = initialStructureRotation;
            inPosition = false;
